...
\begin{itemize}
	...
	\item \textbf{A proof of concept infrastructure implementation:} Through three case studies, we have demonstrated that our system can effectively share mobile hardware resources.
\end{itemize}
...
\captionof{lstlisting}{A typical JSON response and initiative condition.}
...
%\begin{figure}
	...
	%}
	%\caption{Image processing through multiple devices.}
