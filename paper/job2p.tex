...
By increasing the number of devices in network from 2 to 5 and sharing the task with the other peers, we gathered statistic data like below
...
\caption{Image Processing in cluster with 4 peers and extra}
