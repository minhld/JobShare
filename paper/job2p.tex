...
The \texttt{DataParser} class codifies how data to be sent should be processed (e.g., read/write), partitioned, and merged. The \texttt{DataParser} interface described in Listing \ref{code:job_def} has the following methods:
\begin{itemize} \denseitems
...
In our case studies (Section \ref{sec:eval}), we evaluated our programming model through three case studies (i.e., bitmap image processing, internet sharing, and GPS accessing).
...
\begin{tabular}{| l | l | l | l |}
    \hline
    \textbf{Phone} & \textbf{CPU} & \textbf{RAM} & \textbf{Battery} \\ \hline \hline
...
To measure the performance of the system equipped with our APIs, we experimented with three case studies using five different Android devices at an emulated testbed:
\begin{itemize} \denseitems
