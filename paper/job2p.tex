...
\paragraph{Performance}
According to our experiments with CNN URLs, executing Internet Remote access brings the higher benefit in compare with Image processing. Figure \ref{fig:net_clusters_perf} describes performance of , we didn't use 2 device cluster because it 
