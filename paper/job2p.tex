...
Mobile devices have been evolving at a lightning pace with powerful hardware facilities such as multicore CPUs, large and fast memory, fast network, high resolution displays, etc. As a result, mobile devices often overtake the personal computer as a primary means of accessing computing resource. Despite the development of mobile hardware, today's mobile applications are becoming more complicated, thereby requiring more computing resources. 
